    ...
    return SizedBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: Colors.white,
          border: Border.all(width: 1, color: ColorManager.primary.withOpacity(0.8)),
        ),
        child: Column(
          children: [
            // Expanded(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        onTap: () {},
                        child: Image.asset(IconsAssets.icWithList, color: ColorManager.primary),
                      ),
                    ),
                  ),
                ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: getRegularStyle(color: ColorManager.primary, fontSize: 14.sp),
                    ),
                    SizedBox(height: 8.h),
                    Row(
                      ...
                      children: [
                        ...
                        Text("$priceBeforeDiscound EGP ", style: getTextWithLine()),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
