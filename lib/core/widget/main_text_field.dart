            ...
            ? Padding(
                ...
                child: Text(
                  ...
                  style:
                      ...
                      getMediumStyle(color: ColorManager.white).copyWith(fontSize: FontSize.s18.sp),
                ),
              )
            : const SizedBox(),
        Container(
          ...
          child: TextFormField(
            ...
            style: getMediumStyle(color: ColorManager.black).copyWith(fontSize: FontSize.s18.sp),
            obscureText: hidden,
            ...
            decoration: InputDecoration(
              ...
              hintStyle:
                  ...
                  getRegularStyle(color: ColorManager.grey).copyWith(fontSize: 18.sp),
              border: InputBorder.none,
              enabledBorder: InputBorder.none,
              errorStyle: TextStyle(fontSize: AppSize.s0, color: ColorManager.transparent),
            ),
          ),
        ),
        errorText == null
            ? const SizedBox()
            : Padding(
                padding: const EdgeInsets.only(top: AppPadding.p8, left: AppPadding.p8),
                child: Text(
                  errorText!,
                  style: getMediumStyle(color: ColorManager.error).copyWith(fontSize: 18.sp),
                ),
              ),
      ],
    );
