...
import 'package:e_commerce_c18/features/cart/widgets/cart_item_widget.dart';
import 'package:e_commerce_c18/features/cart/widgets/total_price_and_checkout_botton.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            TotalPriceAndCheckoutBotton(totalPrice: 1200, checkoutButtonOnTap: () {}),
