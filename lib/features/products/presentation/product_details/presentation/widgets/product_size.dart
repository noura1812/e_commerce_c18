...
import 'package:e_commerce_c18/features/products/presentation/product_details/presentation/widgets/size_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          'Size',
          style: getMediumStyle(color: ColorManager.appBarTitleColor).copyWith(fontSize: 18.sp),
        ),
        SizedBox(height: 8.h),
        SizedBox(
          height: 45.h,
