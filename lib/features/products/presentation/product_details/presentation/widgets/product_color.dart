import 'package:e_commerce_c18/features/products/presentation/product_details/presentation/widgets/color_widget.dart';
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                ...
                child: ColorItem(color: widget.color[index], index: index, selectedIndex: selected),
              );
            },
