...
class GetCategoriesUsecase {
  ...
  GetCategoriesUsecase({required CategoriesRepo categoriesRepo}) : _categoriesRepo = categoriesRepo;
  Future<CustomResponse<List<CategoryEntity>>> call() => _categoriesRepo.getCategories();
}
